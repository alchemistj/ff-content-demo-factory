...
function cursorDouble() {
  ...
  return {
    ...
    async runResearchRecord({ kind, jobId, input }) {
      ...
      const sourceCheckpoint = input?.decision?.sourceCheckpoint || { sourceIdentity: { provider: 'repository-test-fixture', runId: input?.finalist?.runId || 'run-page-1', artifactId: 'artifact-page-1', sourceSha: 'source-page-1', rootIdentity: 'test-artifact-root:artifact-page-1' }, sourceArtifactDigest: 'sha256:ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff' };
