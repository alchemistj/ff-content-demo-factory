...
const classification = {
  authoritativeJudgmentCount: 5, anchorCount: 4, requestedLimit: 50, dateWindow: null, retrievalCompleteness: 'complete', discoverySampleOnly: false, writtenReviewCount: 5,
  reviews: [
...
const audits = new Map([
  ['rlb', { quality: 'dated', opportunity: 'service pages bury EV charging evidence', inspected: true, siteCopyEvidence: ['EV charging appears only in a flyer'], ownedGraphicEvidence: [{ text: 'EV charger installation', url: 'https://rlb.example/flyer.jpg' }], publicImageUrls: ['https://rlb.example/flyer.jpg'] }],
  ['panel', { quality: 'thin', opportunity: 'unclear panel service', inspected: true, siteCopyEvidence: ['generic electrician copy'], ownedGraphicEvidence: [], publicImageUrls: [] }]
]);
...
test('collision validation, Gate 1 evidence specificity, and expanded Architect QA enforce the boundary', () => {
  ...
  const whyBuilt = 'RLB Electric has direct EV charging installation proof while its dated site buries that opportunity. The NEMA 15-50 customer account and owned EV graphic support a focused considered-purchase page. The demo makes that evidence easier for Dallas prospects to find.';
  ...
  assert.equal(architectQa({ finalist, inventory: classification, prescription, whyBuilt: 'This is a generic site story. It has a page.' }).checks.whyBuiltEvidenceSpecific, false);
