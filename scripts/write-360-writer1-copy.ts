...
const install = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Not every opening is a catalog size. One completed job replaced a 1980 7-foot door with a 9-foot-6 door so a camper van would clear. The opening had already been reframed. Will and Jenny came out to coordinate the door size to that reframing. They coordinated the door size to that reframing; they did not build the opening.\n\nIf your opening is taller, shorter, or simply not a standard size, the useful next step is that same on-site size conversation before anyone orders a door.",
    },
    {
      id: "install-onsite",
