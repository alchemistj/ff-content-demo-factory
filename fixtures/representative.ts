...
const richFixtureBase: Omit<ApprovedProspectHandoff, "sourceCheckpoint" | "digests" | "serviceComparison" | "reviewAnalysisFacts"> = {
  ...
  prospect: {
    ...
    destinations: {
      ...
      strategy: { visibility: "internal", url: "https://northline.example/", label: "Start with the repair decision", decisionPath: "diagnose first, then compare replacement", rationale: "The inventory contains concrete repair evidence and a distinct replacement decision." },
      servicePages: [
